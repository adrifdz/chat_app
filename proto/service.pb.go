...
var file_service_proto_rawDesc = []byte{
	...
	0x0d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x2a,
	...
	0x28, 0x09, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x4a, 0x0a,
	0x07, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x12, 0x27, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73,
	...
	,
...
var file_service_proto_goTypes = []interface{}{
	(*User)(nil),    // 0: proto.service.User
	(*Message)(nil), // 1: proto.service.Message
	(*Connect)(nil), // 2: proto.service.Connect
	(*Close)(nil),   // 3: proto.service.Close
}
var file_service_proto_depIdxs = []int32{
	0, // 0: proto.service.Connect.user:type_name -> proto.service.User
	2, // 1: proto.service.Broadcast.CreateStream:input_type -> proto.service.Connect
	1, // 2: proto.service.Broadcast.BroadcastMessage:input_type -> proto.service.Message
	1, // 3: proto.service.Broadcast.CreateStream:output_type -> proto.service.Message
	3, // 4: proto.service.Broadcast.BroadcastMessage:output_type -> proto.service.Close
...
func (c *broadcastClient) CreateStream(ctx context.Context, in *Connect, opts ...grpc.CallOption) (Broadcast_CreateStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Broadcast_serviceDesc.Streams[0], "/proto.service.Broadcast/CreateStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *broadcastClient) BroadcastMessage(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Close, error) {
	out := new(Close)
	err := c.cc.Invoke(ctx, "/proto.service.Broadcast/BroadcastMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Broadcast_BroadcastMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.service.Broadcast/BroadcastMessage",
	}
...
var _Broadcast_serviceDesc = grpc.ServiceDesc{
	ServiceName: "proto.service.Broadcast",
